...
class TestPhoenix(unittest.TestCase):
    ...
    def badInput(self):
        self.assertEqual(FractalParcer(data/invalid.frac), RuntimeError)

    def goodInput(self):
        self.assertEqual(fractalParcer(data/coral.frac), )

    def defaultFrac(self):
        self.assertEqual(fractalParcer(),)

    def FractalFactoryTest(self):
        self.assertEqual(FractalFactory(fractalParcer(data/coral.frac)),)
