...
* Create new fractal classes, need four, convert Phoenix and Mandelbrot to these for two, raise equation from phoenix to a higer power for another,
The last one will need to be a new equation entierly.
* Create a FractalFactory, this is a class or module that will contain a function to return a fractal object beased on the input supplied by the user.
...
* User Interface, User will know how to get into the command line, they will run the program with optional parameters of fractle name and palette
  * if no arguments are given, default fractal will print.
